...
int main( void )
{
	...
	Global::window = glfwCreateWindow( Global::windowX, Global::windowY, "Tutorial 10 - Transparency", NULL, NULL);
    ...
    glfwPollEvents();
    glfwSetCursorPos(Global::window, Global::windowX/2, Global::windowY/2);
	...
	indices = meshes.loadedMeshes[0]->indices;


	GLuint vertexbuffer = meshes.loadedMeshes[0]->vertexbuffer;
	GLuint uvbuffer = meshes.loadedMeshes[0]->uvbuffer;
	GLuint normalbuffer = meshes.loadedMeshes[0]->normalbuffer;
	GLuint elementbuffer = meshes.loadedMeshes[0]->elementbuffer;
